...
\paragraph{Read} \path{dd_top} reaches near-universal fixation but only 9.6\,\% of clicks. The click-fixation dissociation is preserved at element-type granularity, sharper than at the ad-vs-organic level the original AdSERP analysis used. The pattern (36.4\,\% vs 5.9\,\% for \path{native_ad}, 99.7\,\% vs 9.6\,\% for \path{dd_top}) shows high fixation coverage decoupled from click share. Organic results occupy the initial viewport on 97\,\% of trials and capture 79\,\% of clicks. Ads and widgets hold substantial above-fold geometry while drawing few clicks.
